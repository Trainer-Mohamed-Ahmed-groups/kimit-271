...
// }
console.log(arr1)
arr1.forEach(function (element, i) { console.log(element) })
var test = arr1.map(function (element, i) { return (element) })
console.log(test)

console.log(ages.map(function (age) { return age * age }))
/*********************************************************************************************** */
/*********************************************   array from **************
...
console.log(arr1.splice(1, 2, "JS"));
...
////////////////////////////////////////////////////////////////////
/*
1- concatenate two arrays and check if any item is num or not ( use every and typeof ) and output if greater then 3 .
